...
var _Divider = __webpack_require__(166);
...
var Divider = function Divider(_ref) {
  var className = _ref.className,
      shadow = _ref.shadow,
      props = (0, _objectWithoutProperties3['default'])(_ref, ['className', 'shadow']);
  return _react2['default'].createElement(
    'div',
    (0, _extends3['default'])({ className: (0, _classnames2['default'])('divider', { 'has-shadow': shadow }, className) }, props),
    shadow && _react2['default'].createElement('div', { className: 'shadow-box' })
  );
};
Divider.propTypes = {
