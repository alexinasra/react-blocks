...
var Avatar = function Avatar(_ref) {
  var className = _ref.className,
      src = _ref.src,
      size = _ref.size,
      props = (0, _objectWithoutProperties3['default'])(_ref, ['className', 'src', 'size']);
  return _react2['default'].createElement('img', (0, _extends3['default'])({ className: (0, _classnames2['default'])('avatar', size, className),
    src: src,
    alt: 'avatar'
  }, props));
};
