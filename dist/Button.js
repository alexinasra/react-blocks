...
var Button = function Button(_ref) {
  var className = _ref.className,
      ...
      label = _ref.label,
      props = (0, _objectWithoutProperties3['default'])(_ref, ['className', 'raised', 'iconName', 'label']);
  return _react2['default'].createElement(
    'button',
    (0, _extends3['default'])({ className: (0, _classnames2['default'])('button', { flat: !raised, raised: raised }, className) }, props),
